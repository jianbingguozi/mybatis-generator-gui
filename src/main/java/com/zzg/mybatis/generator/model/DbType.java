...
public enum DbType {
    ...
    MySQL("com.mysql.jdbc.Driver", "jdbc:mysql://%s:%s/%s?useUnicode=true&useSSL=false&characterEncoding=%s&zeroDateTimeBehavior=convertToNull&serverTimezone=UTC", "mysql-connector-java-5.1.38.jar"),
